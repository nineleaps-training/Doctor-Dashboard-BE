...
class AppointmentServiceImplTest {
    ...
    void addAppointment_SUCCESS() throws MessagingException, JSONException, UnsupportedEncodingException {
        ...
        Appointment appointment1 = new Appointment(1L, Category.Dentist, localDate,"fever","sagar","sagarssn23@gmail.com",
                "pranay", localTime,true,"completed",null,null,null,null,2L,patient,doctorDetails,null,null);

        AppointmentDto appointment = new AppointmentDto(Category.Dentist, localDate,"fever","sagar","sagarssn23@gmal.com",
...
//        Context context = Mockito.mock(Context.class);
    ...
    void addAppointment_ThrowErrorIfDateProvidedIsNotInOneWeekRange() throws MessagingException, JSONException, UnsupportedEncodingException {
        ...
        Appointment appointment = new Appointment(1L,Category.Dentist, localDate,"fever","sagar","sagarssn23@gmail.com",
                "pranay", localTime,true,"completed",null,null,null,null,2L,patient,doctorDetails,null,null);

        AppointmentDto appointment1 = new AppointmentDto(Category.Dentist, localDate,"fever","gokul","gok@gmal.com",
                "pranay", localTime,true,"completed",null,2L,patient,doctorDetails);

        AppointmentDto appointment2 = new AppointmentDto(Category.Dentist, localDate1,"fever","ram","ram@gmal.com",
                "pranay", localTime,true,"completed",null,2L,patient,doctorDetails);
...
//                "pranay", localTime,true,"completed",null,null,null,null,2L,patient,doctorDetails,null,null);
        ...
        AppointmentDto appointment1 = new AppointmentDto(Category.Dentist, localDate,"fever","sagar","sagarssn23@gmal.com",
                "pranay", localTime,true,"completed",null,2L,patient,doctorDetails);
    ...
    void addAppointment_IsBookedAgainHaveNullValueAndAppointmentTimeIsInvalid() throws MessagingException, JSONException, UnsupportedEncodingException {
        ...
        Appointment appointment1 = new Appointment(1L,Category.Dentist, LocalDate.now().plusDays(1),"fever","sagar","sagarssn23@gmail.com",
                "pranay", localTime,true,"completed",null,null,null,null,2L,patient,doctorDetails,null,null);

        AppointmentDto appointment = new AppointmentDto(Category.Dentist,  LocalDate.now().plusDays(1),"fever","sagar","sagarssn23@gmal.com",
                "pranay", localTime,true,"completed",null,2L,patient,doctorDetails);
    ...
    void addAppointment_throwErrorIfForTheGivenTimeAppointmentAlreadyBooked() throws MessagingException, JSONException, UnsupportedEncodingException {
        ...
        LocalDate localDate = LocalDate.of(2022,07,13);
        LocalTime localTime = LocalTime.of(10,30);
        ...
        Appointment appointment = new Appointment(1L,Category.Dentist,  LocalDate.now().plusDays(1),"fever","sagar","sagarssn23@gmail.com",
                "pranay", localTime,true,"completed",null,null,null,true,2L,patient,doctorDetails,null,null);

        AppointmentDto appointment1 = new AppointmentDto(Category.Dentist,  LocalDate.now().plusDays(1),"fever","sagar","sagarssn23@gmal.com",
                "pranay", localTime,true,"completed",null,2L,patient,doctorDetails);
...
//        Context context = Mockito.mock(Context.class);
    ...
    void addAppointment_throwErrorForPatientIdDoesNotMatchesWithAppointmentDetailProvided() throws MessagingException, JSONException, UnsupportedEncodingException {
        ...
        Appointment appointment2 = new Appointment(1L,Category.Dentist,  LocalDate.now().plusDays(1),"fever","sagar","sagarssn23@gmail.com",
    ...
    void checkSanityOfAppointment_SUCCESS(){
        ...
        Appointment appointment = new Appointment(1L,Category.Dentist, LocalDate.now(),"fever","sagar","sagarssn23@gmail.com",
    ...
    void getAllAppointmentByPatientId_SUCCESS() {
        ...
        Map<String, PageRecords> getAllAppointment =new HashMap<>();
...
//        Page<Appointment> list1=new PageImpl<>(list);
        Page<Appointment> past=new PageImpl<>(list);
        Page<Appointment> upcoming=new PageImpl<>(list);

        Page<Appointment> today1=new PageImpl<>(list);
        Page<Appointment> today2=new PageImpl<>(list);

        List<PatientAppointmentListDto> dto = new ArrayList<>(Arrays.asList(dto1,dto1));
        List<PatientAppointmentListDto> today = new ArrayList<>(Arrays.asList(dto1,dto1,dto1,dto1));
        getAllAppointment.put("past",new PageRecords(dto,pageNo,pageSize,past.getTotalElements(),past.getTotalPages(),past.isLast()));
        getAllAppointment.put("today",new PageRecords(today,pageNo,pageSize,today.size(),today1.getTotalPages(),today1.isLast()));
        getAllAppointment.put("upcoming",new PageRecords(dto,pageNo,pageSize,upcoming.getTotalElements(),upcoming.getTotalPages(),upcoming.isLast()));

        Mockito.when(patientRepository.getId(Mockito.any(Long.class))).thenReturn(patientId);
        Mockito.when(appointmentRepository.pastAppointment(patientId,paging)).thenReturn(past);
        Mockito.when(appointmentRepository.todayAppointment1(patientId,paging)).thenReturn(today1);
        Mockito.when(appointmentRepository.todayAppointment2(patientId,PageRequest.of(pageNo, pageSize - today1.getNumberOfElements()))).thenReturn(today2);
        Mockito.when(appointmentRepository.upcomingAppointment(patientId,paging)).thenReturn(upcoming);
    ...
    void getAllAppointmentByDoctorId_SUCCESS() {
        ...
        Mockito.when(doctorRepository.isIdAvailable(Mockito.any(Long.class))).thenReturn(doctorId);
        Mockito.when(appointmentRepository.pastDoctorAppointment(doctorId,paging)).thenReturn(past);
        Mockito.when(appointmentRepository.todayDoctorAppointment1(doctorId,paging)).thenReturn(today1);
        Mockito.when(appointmentRepository.todayDoctorAppointment2(doctorId,paging)).thenReturn(today2);
        Mockito.when(appointmentRepository.upcomingDoctorAppointment(doctorId,paging)).thenReturn(upcoming);
