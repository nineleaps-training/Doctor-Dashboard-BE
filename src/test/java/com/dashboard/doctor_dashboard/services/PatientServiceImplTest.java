...
//    @Test
//    void addPatientTest_Pass() {
//        Long id = 1L;
//        PatientEntityDto patientEntityDto = new PatientEntityDto(1L,"7025870157","Male",21,"A+","Address1","9728330045");
...
//    }
    ...
    @Test
    void throwAnErrorIfIdNotPresentInDatabaseForAddDoctor() {
        Long id = 1L;
        PatientEntityDto patientEntityDto = new PatientEntityDto(1L,"7025870157","Male",21,"A+","Address1","9728330045");
...
//    }
    ...
    @Test
    void throwAnErrorIfIdNotPresentInDatabaseForPatientProfile() {
        Long id = 1L;
    ...
    @Test
    void updatePatientDetails_Pass() {
        final Long id = 1L;
        PatientDetailsUpdateDto updateDto = new PatientDetailsUpdateDto(1L,"7025870157");
    ...
    @Test
    void throwAnErrorIfIdNotPresentInLoginDetailsDBForUpdatePatient() {
        final Long id = 1L;
        PatientDetailsUpdateDto updateDto = new PatientDetailsUpdateDto(1L,"7025870157");
    ...
    @Test
    void throwAnErrorIfIdNotPresentInPatientDetailsDBForUpdatePatient() {
        final Long id = 1L;
        PatientDetailsUpdateDto updateDto = new PatientDetailsUpdateDto(1L,"7025870157");
    ...
    @Test
    void throwAnErrorIfIdNotPresentInDBForUpdatePatient() {
        final Long id = 1L;
        PatientDetailsUpdateDto updateDto = new PatientDetailsUpdateDto(1L,"7025870157");
    ...
    @Test
    void getNotificationTest_Pass(){
        Long patientId = 1L;
        NotificationDto dto1 = new NotificationDto(1L,"Gokul");
        NotificationDto dto2 = new NotificationDto(2L,"pranay");
        NotificationDto dto3 = new NotificationDto(3L,"Sagar");
    ...
    @Test
    void throwAnErrorIfIdNotPresentInLoginDetailsDBForNotification() {
        Long patientId = 1L;
    ...
    @Test
    void throwAnErrorIfIdNotPresentInPatientDetailsDBForNotification() {
        Long patientId = 1L;
    ...
    @Test
    void throwAnErrorIfIdNotPresentInDBForNotification() {
        Long patientId = 1L;
        NotificationDto dto1 = new NotificationDto(1L,"Gokul");
        NotificationDto dto2 = new NotificationDto(2L,"pranay");
        NotificationDto dto3 = new NotificationDto(3L,"Sagar");
...
//        Long doctorId = 1L;
//
//        Appointment appointment = new Appointment(1L,"dentist", LocalDate.now(),"fever","gokul","gokul123@gmal.com",
//                "pranay", LocalTime.now(),true,"completed",null,null,null,true,2L,null,null,null,null);
//
//        AppointmentViewDto viewDto = new AppointmentViewDto("gokul","general", LocalDate.now(), LocalTime.now(),"completed","B+", (short) 21,"Male");
//
...
//                "pranay", LocalTime.now(),true,"completed",null,null,null,true,2L,null,null,null,null);
//
//        AppointmentViewDto viewDto = new AppointmentViewDto("gokul","orthology", LocalDate.now(), LocalTime.now(),"completed","B+", (short) 21,"Male");
//
//        Mockito.when(patientRepository.getId(patientId)).thenReturn(loginId);
//        Mockito.when(appointmentRepository.findById(Mockito.any(Long.class))).thenReturn(Optional.of(appointment));
//        Mockito.when(appointmentRepository.getDoctorId(appointmentId)).thenReturn(id);
...
//    }
    ...
    @Test
    void throwAnErrorIfIdNotPresentInAppointmentDbForViewAppointment() {
        Long appointmentId = 1L;
        Long patientId = 1L;
        Long loginId = 1L;
...
//                "pranay", LocalTime.now(),true,"completed",null,null,null,true,2L,null,null,null,null);
//
//        AppointmentViewDto viewDto = new AppointmentViewDto("gokul","dental", LocalDate.now(), LocalTime.now(),"completed","B+", (short) 21,"Male");
//
//        Mockito.when(patientRepository.getId(patientId)).thenReturn(loginId);
//        Mockito.when(appointmentRepository.findById(Mockito.any(Long.class))).thenReturn(Optional.empty());
//        Mockito.when(appointmentRepository.getDoctorId(appointmentId)).thenReturn(null);
