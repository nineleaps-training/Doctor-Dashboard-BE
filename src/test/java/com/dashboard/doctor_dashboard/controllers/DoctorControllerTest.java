...
class DoctorControllerTest {
    ...
    void addDoctorDetails() throws Exception {
        ...
        DoctorFormDto doctorFormDto = new DoctorFormDto(1L,(short) 26,"orthologist","male",
                "9728330045",(short)6,"MBBS");        GenericMessage message  = new GenericMessage(Constants.SUCCESS,doctorFormDto);
...
//    }
    ...
    void checkIfUpdateDoctorDetailsHasError() throws Exception {
        ...
        UserDetailsUpdateDto doctorFormDto = new UserDetailsUpdateDto(1L, "972833045");
