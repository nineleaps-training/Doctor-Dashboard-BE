...
//
////    @Test
////    void addAppointmentTest_Success() throws MessagingException, JSONException, UnsupportedEncodingException {
...
//
//    @Test
//    void showAvailableSlotsTest_Success() {
...
//
//    @Test
//    void getAllAppointmentByPatientIdTest_Success() {
...
//
//    @Test
//    void getAllAppointmentByDoctorIdTest_Success() {
//        final Long doctorId = 1L;
//        Map<String, List<DoctorAppointmentListDto>> map =new HashMap<>();
//        DoctorAppointmentListDto dto1 = new DoctorAppointmentListDto(2L, LocalDate.now(),"gokul","gokul123@gmal.com","completed",LocalTime.now());
//        DoctorAppointmentListDto dto2 = new DoctorAppointmentListDto(3L, LocalDate.now(),"gokul","gokul123@gmal.com","completed",LocalTime.now());
...
//
//    @Test
//    void getTotalNoOfAppointmentTest_Success() {
//        final Long doctorId = 1L;
...
//
//    @Test
//    void getTodayAppointmentsTest_Success() {
//        final Long doctorId = 1L;
...
//
//    @Test
//    void getTotalNoOfAppointmentAddedThisWeekTest_Success() {
//        final Long doctorId = 1L;
...
//
//    @Test
//    void getPatientCategoryGraphTest_Success() {
//        Long patientId = 1L;
...
//
//    @Test
//    void getFollowDetailsTest_Success() {
//        final Long appointId = 1L;
//        FollowUpDto followUpDto = new FollowUpDto(1L,"gokul",1L,"dentist","completed");
//
...
//
////    @Test
////    void getAppointmentByIdTest_Success() {
////        final Long appointId = 1L;
////
////        PatientProfileDto patientProfileDto = new PatientProfileDto(1L,LocalDate.now(),"gokul","gokul123@gmail.com",
